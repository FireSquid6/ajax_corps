...
{
    if on mp_grid_add_rectangle(global.motionGrid,bbox_left,bbox_top,bbox_right,bbox_bottom) else mp_grid_clear_rectangle(global.motionGrid,bbox_left,bbox_top,bbox_right,bbox_bottom)
